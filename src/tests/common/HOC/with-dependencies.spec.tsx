  ...
  describe('withDependencies HOC', () => {
    ...
    it('Throws error if can not resolve dependencies', () => {
      ...
      expect(() => {
        ...
        .toThrow(`No registration in container '${testContainerName}' for qualifier '${testInjectionQualifier1}' requested by '${Component.name}'`)
    })
    ...
    it('Provides dependencies to wrapped component', () => {
      ...
      const wrapper = shallow(<ComponentWithDependencies value={'test'}/>)
    ...
    it('Accepts properties for wrapped component and passes them', () => {
      ...
      const wrapper = shallow(<ComponentWithDependencies value={testValue}/>)
